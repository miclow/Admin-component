 ...
 * @since  1.6
 */
class Event_manageModelTerm extends JModelAdmin
{
	/**
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Term', $prefix = 'Event_manageTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_event_manage.edit.term.data', array());
