...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'term.cancel') {
			Joomla.submitform(task, document.getElementById('term-form'));
		}
		else {
			
			if (task != 'term.cancel' && document.formvalidator.isValid(document.id('term-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="term-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_EVENT_MANAGE_TITLE_TERM', true)); ?>
		<div class="row-fluid">
