 ...
 * @since  1.6
 */
class Event_manageViewEvents extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Event_manageHelper::addSubmenu('events');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EVENT_MANAGE_TITLE_EVENTS'), 'events.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_event_manage&view=events');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`start_date`' => JText::_('COM_EVENT_MANAGE_EVENTS_START_DATE'),
